...
# 2 "leitorLM35_v07.c" 2

# 1 "./delay.h" 1
# 11 "./delay.h"
void delay(unsigned int t);
# 3 "leitorLM35_v07.c" 2
...
unsigned int adcLer(void)
{
    ...
    while(ADCON0bits.GO);
# 40 "leitorLM35_v07.c"
    adc01Temp = (unsigned) (ADRESH<<8) | ADRESL;
    return adc01Temp;
}

unsigned char temperaturaLer(void)
{
    unsigned int temp01VlrInt;
    unsigned int temp01VlrTmp;
    temp01VlrInt = adcLer();
    temp01VlrTmp =(unsigned int) (temp01VlrInt * 0.48875);
    return temp01VlrTmp;
}

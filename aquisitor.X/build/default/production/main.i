...
unsigned char tecAtual;

const unsigned char tabTeclas[]={'1','4','7','*','2','5','8','0','3','6','9','#','A','B','C','D'};
...
{
    PORTBbits.RB7=1,PORTBbits.RB6=1,PORTBbits.RB5=1,PORTBbits.RB4=0;
    __nop();__nop();
    if(!PORTBbits.RB0) tecAtual = tabTeclas[0];
    else if(!PORTBbits.RB1) tecAtual = tabTeclas[1];
    else if(!PORTBbits.RB2) tecAtual = tabTeclas[2];
    else if(!PORTBbits.RB3) tecAtual = tabTeclas[3];

    PORTBbits.RB7=1,PORTBbits.RB6=1,PORTBbits.RB5=0,PORTBbits.RB4=1;
    __nop();__nop();
    if(!PORTBbits.RB0) tecAtual = tabTeclas[4];
    else if(!PORTBbits.RB1) tecAtual = tabTeclas[5];
    else if(!PORTBbits.RB2) tecAtual = tabTeclas[6];
    else if(!PORTBbits.RB3) tecAtual = tabTeclas[7];

    PORTBbits.RB7=1,PORTBbits.RB6=0,PORTBbits.RB5=1,PORTBbits.RB4=1;
    __nop();__nop();
    if(!PORTBbits.RB0) tecAtual = tabTeclas[8];
    else if(!PORTBbits.RB1) tecAtual = tabTeclas[9];
    else if(!PORTBbits.RB2) tecAtual = tabTeclas[10];
    else if(!PORTBbits.RB3) tecAtual = tabTeclas[11];

    PORTBbits.RB7=0,PORTBbits.RB6=1,PORTBbits.RB5=1,PORTBbits.RB4=1;
    __nop();__nop();
    if(!PORTBbits.RB0) tecAtual = tabTeclas[12];
    else if(!PORTBbits.RB1) tecAtual = tabTeclas[13];
    else if(!PORTBbits.RB2) tecAtual = tabTeclas[14];
    else if(!PORTBbits.RB3) tecAtual = tabTeclas[15];


    if(tecAtual!=tecAnterior)
    {
